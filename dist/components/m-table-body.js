...
var MTableBody = /*#__PURE__*/function (_React$Component) {
  ...
  (0, _createClass2["default"])(MTableBody, [{
    ...
    value: function render() {
      ...
      return /*#__PURE__*/React.createElement(_TableBody["default"], {
        ref: (_this$props$provided = this.props.provided) === null || _this$props$provided === void 0 ? void 0 : _this$props$provided.innerRef
      }, this.props.options.filtering && /*#__PURE__*/React.createElement(this.props.components.FilterRow, {
        ...
        onEditingApproved: this.props.onEditingApproved,
        getFieldValue: this.props.getFieldValue
      }), this.renderEmpty(emptyRowCount, renderData), this.props.provided.placeholder);
    }
  }]);
  return MTableBody;
}(React.Component);
