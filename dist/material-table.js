...
var MaterialTable = /*#__PURE__*/function (_React$Component) {
  ...
  function MaterialTable(_props) {
    ...
    (0, _defineProperty2["default"])((0, _assertThisInitialized2["default"])(_this), "draggableRowsIdentifier", "draggable-rows");
    ...
    (0, _defineProperty2["default"])((0, _assertThisInitialized2["default"])(_this), "onChangePage", function (event, page) {
      if (_this.isRemoteData()) {
        ...
        _this.setState(_this.dataManager.getRenderState(), function () {
          _this.props.onChangePage && _this.props.onChangePage(page, _this.state.query.pageSize);
        });
      }
    });
    ...
    (0, _defineProperty2["default"])((0, _assertThisInitialized2["default"])(_this), "onDragEnd", function (result) {
      if (_this.props.options.draggableRows) {
        ...
        if (result.source.droppableId === _this.draggableRowsIdentifier && _this.props.onRowDrop) {
    ...
    (0, _defineProperty2["default"])((0, _assertThisInitialized2["default"])(_this), "toggleDraggableClass", function (result) {
      var container = _this.tableContainerDiv.current;
      container.style.height = container.getBoundingClientRect().height + "px";
      var row = container.querySelector('tr[data-rbd-draggable-id="' + result.draggableId + '"]');
    ...
    (0, _defineProperty2["default"])((0, _assertThisInitialized2["default"])(_this), "renderTable", function (props) {
      return /*#__PURE__*/React.createElement(_Table["default"], {
      ...
      }), /*#__PURE__*/React.createElement(_reactBeautifulDnd.DragDropContext, {
        ...
        return /*#__PURE__*/React.createElement(props.components.Body, {
          provided: provided,
          actions: props.actions,
  ...
  (0, _createClass2["default"])(MaterialTable, [{
    ...
    value: function render() {
      ...
      return /*#__PURE__*/React.createElement(_reactBeautifulDnd.DragDropContext, {
        ...
        theme: props.theme
      })), this.state.errorState && this.state.errorCause === "query" && /*#__PURE__*/React.createElement("div", {
        style: {
          position: "absolute",
          top: 0,
          left: 0,
